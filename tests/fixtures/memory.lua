...
function M.mission(kind)
    ...
    put(game+0x277fe60,qword(screen))
    put(screen+140,record(24,{[0]=word(12),[20]=word(1)}))
    put(game+0x276c078,qword(root))
    put(root+0xae220,qword(controller))
    put(game+0x277ff28,qword(board))
    ...
    put(game+0x26d3560+9*816,record(816,{[272]=word(1),[candidate]=word(tag),[candidate+4]=float(1)}))
    put(game+0x277fe28,qword(config))
    put(config+73848,string.rep('\0',24))
    put(config+49232,string.rep('\0',24))
    put(game+0x2a762a4+872*84,word(0))
    if joined then
        put(board+1548956,word(planet))
        put(board+2058929,string.char(1))
        put(board+1548964,word(0xffffffff)..word(0))
        put(game+0x276c7b8,qword(fallback))
        ...
        put(game+0x277feb8,qword(remote))
        ...
        put(root+713296,packet)
        put(board+4281196,word(0))
    end
...
function M.presentation(kind)
    ...
    put(game+0x277fe60,qword(screen))
    put(screen+140,record(24,{[0]=word(briefing and 11 or 12),[20]=word(1)}))
    put(game+0x276cb80,qword(manager))
    put(manager+25048,word(1)..word(0)..qword(owner)..word(224)..word(0))
    put(manager+25096,word(1)..word(0)..qword(owner)..word(227)..word(0))
    put(owner+8,word(kind=='loadout' and 1 or 0))
    put(owner+31168,M.widget(512,894.1667,533,360))
    ...
    put(game+0x2a750d8,word(0xc5d17df2)..word(0xb56d2aba))
    put(game+0x2ac7058,qword(material))
    put(material+24,word(0x3ff20cbb)..word(0x9f85b87d))
    put(game+0x2a75d58,word(0xc79f934b)..word(0xd1ebb991))
